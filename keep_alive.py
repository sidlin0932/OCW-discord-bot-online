...
<body>
    <div class="container">
        ...
        <h2>📅 最新週報 ({{ latest_report.range_str if latest_report else '尚無資料' }})</h2>
        {% if latest_report %}
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ user.threads_participated|length }}</td>
        ...
        <div class="footer">
            Generated by OCW Bot v1.2.4 | <a href="/trends">📈 趨勢圖</a> | <a href="/api/stats">API View</a>
        </div>
    </div>
</body>
</html>
...
<body>
    <div class="container">
        ...
        {% else %}
            <div class="controls">
                <strong>🔍 篩選學生：</strong><br><br>
                <label><input type="checkbox" id="select-all" checked> 全選/全不選</label><br><br>
        ...
        <div class="footer">
            Generated by OCW Bot v1.2.4 | <a href="/">返回儀表板</a>
        </div>
    </div>
...
def trends():
    if db is None:
        return render_template_string(TRENDS_HTML, error="❌ 資料庫未連接 (請檢查 MONGO_URI)", chart_data=None)
    ...
    try:
        ...
        if not all_reports:
            return render_template_string(TRENDS_HTML, error="❌ 尚無歷史數據，請稍候 Bot 自動計算", chart_data=None)
        ...
        return render_template_string(TRENDS_HTML, error=f"❌ 載入數據時發生錯誤: {str(e)}", chart_data=None)
